...
- Treat any USER PERSONAL NOTE as the user's own secondary observation. You may mention it when relevant, but never let it silently rewrite or replace canonical wine facts or the canonical drinking lifecycle.
