...
export function WineProfile({ wine, bottleCount }: { wine: Wine; bottleCount?: number }) {
  ...
  return <article className="wine-profile">
    ...
    {bottleCount !== undefined && <ProfileSection title="Estimated Market Value"><Details values={[["Estimated Market Value", marketValue ?? "Currently unavailable"]]} /></ProfileSection>}
