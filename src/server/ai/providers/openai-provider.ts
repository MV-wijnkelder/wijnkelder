...
const profileSchema = {
  ...
  properties: {
    ...
    drinking: { type: "object", additionalProperties: false, properties: { drinkFrom: { type: ["string", "null"] }, peakFrom: { type: ["string", "null"] }, peakUntil: { type: ["string", "null"] }, drinkBy: { type: ["string", "null"] }, currentMaturity: { type: ["string", "null"], enum: ["young", "approaching peak", "ready", "mature", "past peak", null] } }, required: ["drinkFrom", "peakFrom", "peakUntil", "drinkBy", "currentMaturity"] },
