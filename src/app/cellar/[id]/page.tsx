...
function Profile({ wine }: { wine: StoredWine }) {
  ...
  return <article className="wine-profile">
    ...
    <ProfileSection title="Wine"><Details values={[["Style", profile.style.wineStyle], ["Body", profile.style.body], ["Acidity", profile.style.acidity], ["Tannin", profile.style.tannin], ["Sweetness", profile.style.sweetness], ["Alcohol", profile.style.alcohol ?? (wine.alcoholPercentage ? `${wine.alcoholPercentage}%` : null)]]} /></ProfileSection>
