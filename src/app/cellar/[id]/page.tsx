...
function Profile({ wine }: { wine: StoredWine }) {
  ...
  return <article className="wine-profile">
    ...
    <ProfileSection title="Wine"><Details values={[["Color", wine.wineColor], ["Bottle size", wine.bottleSize], ["Alcohol", wine.alcoholPercentage === null ? null : `${wine.alcoholPercentage}%`], ["Style", profile.style.wineStyle], ["Body", profile.style.body], ["Acidity", profile.style.acidity], ["Tannin", profile.style.tannin], ["Sweetness", profile.style.sweetness], ["Alcohol intensity", profile.style.alcohol], ["Bottles", String(wine.bottleCount)]]} /></ProfileSection>
